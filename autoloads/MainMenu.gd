...
func _setup_gacha_pool() -> void:
	...
	var paths := [
		...
		"res://Resources/heroes/hero_Vael.tres",
		"res://Resources/heroes/hero_Sera.tres",
	]
	for path in paths:
...
func _build_ui() -> void:
	...
	roster_lbl.text = "Available heroes:  Tirus · Brom · Lyra · Kael · Vael · Sera"
	roster_lbl.modulate = Color(0.7, 0.7, 0.9)
	...
	_seed_input.custom_minimum_size.x = 340
	...
	start_btn.custom_minimum_size = Vector2(340, 54)
	...
	if FileAccess.file_exists("user://run_save.json"):
		...
		cont_btn.custom_minimum_size = Vector2(340, 54)
